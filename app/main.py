...
from app.api.endpoints import upload, training_data
...
# Include API routers
app.include_router(upload.router, prefix="/api/v1", tags=["telemetry"])
app.include_router(training_data.router, prefix="/api/v1", tags=["ingestion"])
